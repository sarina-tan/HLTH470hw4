...
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/1_Plan_Data.py").read())

print("\n3) Read in service area data...")
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/3_Service_Areas.py").read())

print("\n4) Read in market pentration data...")
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/4_Penetration_Files.py").read())

print("\n5) Read in MA star rating data ...")
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/rating_variables.py").read())
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/5_Star_Ratings.py").read())

print("\n7) Read in final benchmark rates...")
exec(open("/Users/sarinatan/Desktop/HLTH470hw4/submission1/data-code/7_MA_Benchmark.py").read())
